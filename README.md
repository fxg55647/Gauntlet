...
Gauntlet is a modular security proxy for LLM pipelines. Drop it in front of any LLM API and every input is forced through a configurable chain of security modules before it reaches the model.
